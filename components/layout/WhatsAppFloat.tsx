...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      aria-label="WhatsApp"
      className="fixed bottom-24 right-4 z-50 inline-flex items-center gap-2.5 rounded-[2px] bg-navy px-4 py-3 text-sm font-medium text-white shadow-lg transition-transform duration-300 hover:-translate-y-0.5 hover:bg-accent sm:bottom-8 sm:right-8 sm:gap-4 sm:px-6 sm:py-4 sm:text-base"
    >
