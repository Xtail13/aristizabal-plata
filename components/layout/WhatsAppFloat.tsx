...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      aria-label="WhatsApp"
      className="fixed bottom-5 right-4 z-50 inline-flex items-center gap-2 rounded-[2px] bg-navy px-3 py-2.5 text-xs font-medium text-white shadow-lg transition-transform duration-300 hover:-translate-y-0.5 hover:bg-accent sm:bottom-8 sm:right-8 sm:gap-4 sm:px-6 sm:py-4 sm:text-base"
    >
      <span className="grid h-6 w-6 place-items-center rounded-full bg-[#25D366] sm:h-9 sm:w-9">
